...
def create_message_event(message_timestamp=MESSAGE_TIMESTAMP, user_id=USER_ID, additional_event_info=None):
    event = {
...
class MessageViewTests(TestCase):
    ...
    def test_post_to_contact_service_when_messages_overlap(self):
        ...
        another_member = MemberFactory.create(
            slack_id='user_5678',
            team=self.team,
        )
